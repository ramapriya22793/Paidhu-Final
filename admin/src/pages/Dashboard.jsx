...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // If it takes more than 3 seconds, it's likely a server cold start
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await axios.get((import.meta.env.VITE_API_URL || 'https://paidhu-final-anm2.vercel.app') + '/api/admin/stats', config);
