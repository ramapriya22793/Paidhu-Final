...
const AuthModal = ({ isOpen, onClose, onLoginSuccess, user, onLogout }) => {
  ...
  const isRealUser = user && !(user.email && (user.email.startsWith('guest_') || user.email.endsWith('@paidhu.local')));
