...
const defaultData = {
  heroSection: {
    ...
    bannerImage: '/bloom_cookies_banner.png',
    buttons: [
  ...
  formSection: {
    disclaimer: 'Disclaimer: We do not accept international bulk orders. For Further Queries Contact us at +91 8754787774 or info@paidhu.com',
