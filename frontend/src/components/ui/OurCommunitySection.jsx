...
const OurCommunitySection = () => {
  ...
  if (loading) {
    return (
      <div className="w-full min-h-[50vh] flex items-center justify-center bg-[#faf9f7]">
  ...
  const handleVideoClick = () => {
    if (data.highlights?.videoUrl) {
      window.open(data.highlights.videoUrl, '_blank', 'noopener,noreferrer');
    }
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {data.learn.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-[#faf9f7] rounded-3xl p-6 border border-gray-100 flex flex-col items-center text-center space-y-4"
              >
                <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-[#662654]/20 shadow-md">
                  <img
                    src={item.image}
                    alt={item.name}
                ...
                <div className="space-y-1">
                  <h3 className="font-serif font-black text-gray-800 tracking-tight text-base uppercase">
                    {item.name}
                  </h3>
                  <span className="text-[10px] font-black text-[#fbc225] bg-[#662654] px-2.5 py-0.5 rounded-full uppercase tracking-wider block w-fit mx-auto">
                    {item.title}
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            <motion.div 
              ...
              className="relative w-full h-[240px] sm:h-[350px] rounded-3xl overflow-hidden shadow-xl border border-gray-100 cursor-pointer group"
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-colors flex items-center justify-center">
                <div className="w-16 h-16 bg-[#fbc225] rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                  <Play size={24} className="text-[#522742] fill-[#522742] ml-1" />
                </div>
              </div>
            </motion.div>
          </div>
