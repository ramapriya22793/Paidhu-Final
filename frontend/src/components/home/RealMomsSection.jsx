  ...
  return (
    <section className="relative w-full bg-[#faf7f3] overflow-hidden">
      ...
      <div className="w-full overflow-hidden leading-[0] transform rotate-180">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[35px] md:h-[50px]">
      ...
      <div className="w-full max-w-[1360px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 pt-8 md:pt-12 pb-12 md:pb-16">
        ...
        {/* Right — Real Community Slideshow Showcase */}
        <motion.div
          initial={{ opacity: 0, x: 30 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="relative w-full h-[360px] sm:h-[430px] md:h-[480px] lg:h-[530px] rounded-3xl md:rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white bg-white/60">
            ...
            {/* Badges on the image */}
            <div className="absolute bottom-4 left-5 right-5 flex items-center justify-between z-10 pointer-events-none">
              <span className="text-[11px] sm:text-xs font-bold text-white bg-[#522742]/85 backdrop-blur-md px-3 py-1.5 rounded-full shadow-sm">
                Paidhu Family Gatherings
              </span>
              <span className="text-[11px] sm:text-xs font-bold text-white/90 bg-black/40 backdrop-blur-md px-2.5 py-1 rounded-full">
