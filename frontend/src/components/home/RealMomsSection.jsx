...
const RealMomsSection = () => {
  ...
  return (
    <section className="relative w-full bg-[#faf7f3] pt-0 pb-0 overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between pt-12 md:pt-16 pb-12 md:pb-0 px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 text-left mb-10 md:mb-0 pr-4 md:pr-8 lg:pr-12"
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#522742] font-serif mb-4 tracking-tight">
            Paidhu Community
          </h2>
          <p className="text-lg md:text-xl font-bold text-[#522742]/85 mb-6 max-w-lg leading-snug">
