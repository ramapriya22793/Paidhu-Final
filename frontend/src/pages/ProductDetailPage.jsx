            ...
            <div className="relative w-full flex items-center justify-center p-2 sm:p-4 my-auto">
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 w-full z-10">
                    ...
                    {galleryItems.map((item, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`group/thumb relative rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer md:[transform:translateX(var(--arc-x))] ${
                            isSelected 
                              ? 'w-14 h-14 sm:w-16 sm:h-16 md:w-[68px] md:h-[68px] border-2 border-[#cc2229] ring-2 ring-[#cc2229]/20 shadow-[0_6px_20px_rgba(204,34,41,0.25)] scale-110 z-20 bg-white' 
                              : 'w-12 h-12 sm:w-14 sm:h-14 md:w-[60px] md:h-[60px] border border-[#d0d7e5] shadow-[0_4px_12px_rgba(0,0,0,0.06)] bg-white hover:border-[#cc2229] hover:scale-105'
                          }`}
                          title={item.title}
                ...
                <div className="relative w-full max-w-[320px] sm:max-w-[380px] md:max-w-[440px] lg:max-w-[480px] aspect-square rounded-full bg-white shadow-[0_15px_45px_rgba(30,45,75,0.08)] border border-white/80 flex items-center justify-center p-6 sm:p-8 md:p-10 order-1 md:order-2 group z-20">
                    ...
                    {mainImgLoading && (
                      <div className="absolute inset-0 bg-white/70 backdrop-blur-xs rounded-full flex items-center justify-center">
                        <div className="flex flex-col items-center gap-2">
                          <span className="text-3xl animate-spin text-[#cc2229]">🌸</span>
                  ...
                  {/* Red Zoom Button at Bottom-Right matching screenshot */}
                  <button
                    type="button"
                    onClick={() => setLightboxOpen(true)}
                    className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-white border-2 border-[#cc2229] text-[#cc2229] flex items-center justify-center shadow-md hover:bg-[#cc2229] hover:text-white transition-all duration-300 cursor-pointer z-30 hover:scale-110"
